...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(260, 80, 291, 61))
        font = QtGui.QFont()
        ...
        #Binding the click event of the menu options
    ...
    def retranslateUi(self, MainWindow):
        ...
        # code for the MenuBar options
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuEdit.setTitle(_translate("MainWindow", "Edit"))

        # setting up shortcuts and status tool tip of the sub menu options
        #New
